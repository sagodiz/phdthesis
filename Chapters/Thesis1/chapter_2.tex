\chapter{Comparing Large Language Models}
\label{chapter_2}
...
\begin{figure}[htbp]
  ...
  \includegraphics[width=0.99\linewidth]{Chapters/Thesis1/fig/overview.png}
	\caption{ \textbf{Overview of the methodology with key elements.}
	\label{fig:overview}}
\end{figure}
\vspace{-5 px}
...
\begin{table*}[!h]
	\begin{tabular}{|p{1.8cm}|rr|r|rr|r||rr|r|rr|r|}
		\hline
...
\begin{table*}[!h]
	\begin{adjustbox}{width=\linewidth,center} %\columnwidth
		\footnotesize
		\begin{tabular}{|p{1.58cm}|rr|rr|rr|rr|rr|r||rr|rr|rr|rr|rr|r|}
			\hline

...
A \ref{chapter_4}. fejezetben egy adathalmazt állítottunk elő, mely 18.900 feldolgozatlan és 18.896 feldolgozott LLM által generált C++ kódot tartalmaz.
...
Ezek a feladatok kerültek a modellek promptjába a saját promptunk mellé, melyet úgy alkottunk meg, hogy figyelembe vettünk több jó promptolási gyakorlatot, akárcsak a szerepkör definiálás vagy a few-shot-learning, mely példákat ad a modellnek a promptban.
...
A GPT-4 modell segítségével úgy generáltattuk a kódot, hogy az egy eredeti verzióból kiindulva megtartsa annak működését, de javítsa ki a benne rejlő sérülékenységet.

Ezt a Vul4J teszthalmazon értékeltük ki, mely valós életbeli sérülékenységet gyűjteménye.

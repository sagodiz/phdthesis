...
\newcommand{\doctype}{Summary of PhD Thesis}
\include{titlepage}
...
In contrast to methods, everyone got used to, LLMs cannot be used without proper prompting.
...
\vspace{2em}
The publications relevant to the first thesis point are:
\begin{itemize}
...
Investigating hyperparameters like temperature of LLMs is crucial, although it requires a tremendous amount of model inferences.
...
Infering LLMs especially larger ones requires special hardware which might not be available for everyone who wants to research LLMs.
...
The aim of this thesis is to discover and deepen the connection between developers and LLMs as an ultimate development aid, therefore, this thesis is designed to discover many aspects of LLMs which could be useful for a developer, regarding possible comparison techniques.

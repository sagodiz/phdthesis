...
\\
The \textit{second thesis point}, described in \autoref{chapter_4}, investigates hyper-parameter usage and overfitted benchmarks, introducing a dataset to show that temperature remains an underexplored factor in mastering LLM-based code generation.
\thesistwotext

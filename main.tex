...
\input{thesis_point_definitions}

\renewcommand{\chapterautorefname}{Chapter}


\newcommand{\selectedquote}{''The real problem is not whether machines think but whether men do.''}
\newcommand{\theguy}{B. F. Skinner}
...
% Thesis:
\include{Chapters/Thesis1/chapter}
\include{Chapters/Thesis2/chapter}
\include{Chapters/Thesis3/chapter}
% References:

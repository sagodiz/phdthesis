...
\chapter{Deeper Analysis of LLM Temperature}
\label{chapter_4}
...
Schäfer et al.~\cite{unittest_llm} used LLMs to generate unit tests, Xia et al.~\cite{apr_llm} performed automated program repair using LLMs, Song et al.~\cite{generation_llm} synthesized full programs.
...
Xia et al.~\cite{shared_common_data} used multiple common datasets, such as Defects4J~\cite{defect4j}, QuixBugs~\cite{quixbugs}, and ManyBugs~\cite{manybugs_introclass}.
...
\begin{figure}[!h]
	...
	\begin{subfigure}[t]{0.5\textwidth}
		\centering
		\includegraphics[height=1.7in]{Chapters/Thesis3/fig/usecase/rq1-averaged-Qwen-family-2019_D}
		\caption{Qwen models on task 2019 D}
	\end{subfigure}%
	\\
	\begin{subfigure}[t]{0.5\textwidth}
		\centering
		\includegraphics[height=1.7in]{Chapters/Thesis3/fig/usecase/rq1-averaged-Qwen-family-2022_B}

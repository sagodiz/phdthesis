...
In this work, we introduced a methodology for comparing LLMs.
This methodology enables developers to evaluate models in depth and across a broad range of dimensions.
To illustrate its application, we presented a use case involving two LLMs: ChatGPT and Codex.
